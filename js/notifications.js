...
export class NotificationManager {
    ...
    show(message, type = 'info') {
        ...
        // Prepend to show newest at top (stack downwards) or Append?
        // macOS Notifications usually stack. newest on top? 
        // Let's Append (newest at bottom) for standard web toast feel, 
        // BUT macOS puts new ones at Top Right.
        // Let's Prepend so it pushes others down.
