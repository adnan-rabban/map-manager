...
export const GroupItem = ({ group, locations, onFlyTo, onEdit, onDelete, onToggleVisibility, onDeleteGroup, onRenameGroup, onExportGroup, groups, onAssignLocationToGroup, selectedLocationId }) => {
