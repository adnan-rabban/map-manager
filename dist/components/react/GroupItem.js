...
export const GroupItem = ({ group, locations, onFlyTo, onEdit, onDelete, onToggleVisibility, onDeleteGroup, onRenameGroup, groups, onAssignLocationToGroup }) => {
