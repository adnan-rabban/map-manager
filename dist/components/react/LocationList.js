...
export const LocationList = ({ groups, locations, onFlyTo, onEdit, onDelete, onToggleVisibility, onDeleteGroup, onRenameGroup, onAssignLocationToGroup }) => {
